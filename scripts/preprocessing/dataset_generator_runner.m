...
csv_file_lits = cellfun(@(p) fullfile(projectRoot, p), csv_file_lits, 'UniformOutput', false);
anchors_list = cellfun(@(p) fullfile(projectRoot, p), anchors_list, 'UniformOutput', false);
export_csv_file_list = cellfun(@(p) fullfile(projectRoot, p), export_csv_file_list, 'UniformOutput', false);
