...
csv_file = fullfile(projectRoot, 'csv-data', 'const1', 'const1-trial1-tdoa2.csv');
anchors = fullfile(projectRoot, 'survey-results', 'anchor_const1_survey.txt');
data_extractor;
load(fullfile(projectRoot, 'models', 'legacy', 'trained_tdoa_net_lstm.mat'));
